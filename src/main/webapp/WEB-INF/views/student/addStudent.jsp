...
<t:dashboard>
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="first_name">Họ<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="first_name" class="form-control validate[required,custom[onlyLetterSp]] text-input" type="text" value="" name="first_name">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="middle_name">Tên lót</label>
			<div class="col-sm-8">
				<input id="middle_name" class="form-control " type="text" value="" name="middle_name">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="last_name">Tên<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="last_name" class="form-control validate[required,custom[onlyLetterSp]] text-input" type="text" value="" name="last_name">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="gender">Giới tính<span class="require-field">*</span></label>
			<div class="col-sm-8">
							<label class="radio-inline">
			     <input type="radio" value="male" class="tog validate[required]" name="gender" checked="checked">Nam			    </label>
			    <label class="radio-inline">
			      <input type="radio" value="female" class="tog validate[required]" name="gender">Nữ 
			    </label>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="birth_date">Ngày sinh<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="birth_date" class="form-control validate[required] hasDatepicker" type="text" name="birth_date" value="">
			</div>
		</div>		
		<div class="form-group">
			<label class="col-sm-2 control-label" for="address">Địa chỉ<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="address" class="form-control validate[required]" type="text" name="address" value="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="city_name">Tỉnh/Thành phố<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="city_name" class="form-control validate[required]" type="text" name="city_name" value="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="state_name">Đường</label>
			<div class="col-sm-8">
				<input id="state_name" class="form-control" type="text" name="state_name" value="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="zip_code">Mã bưu điện<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="zip_code" class="form-control  validate[required,custom[onlyLetterNumber]]" type="text" name="zip_code" value="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="mobile_number">SĐT #1</label>
			<div class="col-sm-2">
			
			<input type="text" readonly value="+84" class="form-control text-input" name="phonecode">
			</div>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="mobile_number">SĐT #2</label>
			<div class="col-sm-2">
			
			<input type="text" readonly value="+84" class="form-control text-input" name="alter_mobile_number">
			</div>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label " for="phone">SĐT<span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="username">UserName<span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="username" class="form-control validate[required]" type="text" name="username" value="">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="password">Mật khẩu<span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<!--
		<div class="form-group">
			<label class="col-sm-2 control-label" for="photo">Ảnh</label>
			<div class="col-sm-2">
		...
		<div class="col-sm-offset-2 col-sm-8">
        	...
        	<input type="submit" value="Thêm" name="save_student" class="btn btn-success">
        </div>
