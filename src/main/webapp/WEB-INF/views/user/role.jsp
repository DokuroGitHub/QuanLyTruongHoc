		...
		<div class="box box-default" data-collapsed="0">
        	<div class="box-header with-border">
            	<div class="box-title">
					...
					Quản lý vai trò(Manage Role)</span>            	
				</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"> <span><i class="fa fa-role"></i></span>Thêm Vai trò(Role)</h4>
      </div>
      <div class="modal-body">
      <form action="#" method="post" class="form-horizontal" id="addRoleForm">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="roleName">Tên vai trò(Role Name)<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id="roleName" class="form-control validate[required] text-input" type="text">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="displayName">Tên hiển thị(Role Display Name)<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id=displayName class="form-control text-input" type="text">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="lastName">Miêu tả(Role Description)</label>
			<div class="col-sm-6">
      ...
      <div class="modal-footer">
        <button class="btn btn-success" id="roleSubmit">Thêm</button>
