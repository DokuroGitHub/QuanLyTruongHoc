		...
		<div class="box box-default" data-collapsed="0">
        	<div class="box-header with-border">
            	<div class="box-title">
					...
					Quản lý người dùng(Manage User)</span>            	
				</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"> <span><i class="fa fa-user"></i></span> Thêm người dùng(Add User)</h4>
      </div>
      <div class="modal-body">
      <form action="#" method="post" class="form-horizontal" id="addUserForm">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="firstName">Họ<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id="firstName" class="form-control validate[required] text-input" type="text" name="firstName">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="lastName">Tên<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id="lastName" class="form-control validate[required] text-input" type="text" name="lastName">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="gender">Giới tính<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id="gender" name="gender" class="validate[required]" type="radio" value="M"> Nam&nbsp;&nbsp;
				<input id="gender" name="gender" class="validate[required]" type="radio" value="M"> Nữ
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="password">Mật khẩu<span class="require-field">*</span></label>
			<div class="col-sm-6">
				<input id="password" class="form-control validate[required] text-input" type="password" name="password" autocomplete="off">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="retypePassword">Xác nhận mật khẩu<span class="require-field">*</span></label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="rollCombo">Chọn vai trò<span class="require-field">*</span></label>
			<div class="col-sm-6">
      ...
      <div class="modal-footer">
        <button class="btn btn-success" id="userSubmit">Thêm</button>
