...
<t:dashboard>
	...
	<jsp:attribute name="contentHeader">
      <h2 class="page-header">Quản lý quyền(Permission)</h2>
	</jsp:attribute>
	<jsp:body>
      <!-- START CUSTOM TABS -->
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">QUyền(Permission)</a></li>
              <li><a href="#tab_2" data-toggle="tab">Vai trò-Quyền(Role Permission)</a></li>
              <li><a href="#tab_3" data-toggle="tab">Người dùng-Quyền(User Permission)</a></li>
            </ul>
